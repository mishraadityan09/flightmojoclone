...
class _DatePickerBottomSheetState extends State<DatePickerBottomSheet> {
  ...
  double get priceFontSize => (screenWidth * 0.022).clamp(10, 12);
  ...
  void initState() {
    ...
    endDate = DateTime(now.year, now.month, now.day).add(const Duration(days: 360));
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                if (departureDate != null || returnDate != null) const SizedBox(width: 12),
                Expanded(
...
// Function to show Bottom Sheet remains unchanged
