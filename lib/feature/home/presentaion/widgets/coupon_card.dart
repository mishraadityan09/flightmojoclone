...
class CustomTicketShape extends CustomClipper<Path> {
  ...
  CustomTicketShape(this.borderRadius, {this.notchRadius = 15, required this.notchY});
...
class TicketBorderPainter extends CustomPainter {
  ...
  TicketBorderPainter({this.borderRadius = 15, this.notchRadius = 15, required this.notchY});

  @override
  void paint(Canvas canvas, Size size) {
    final path = CustomTicketShape(borderRadius, notchRadius: notchRadius, notchY: notchY).getClip(size);
    final paint = Paint()
...
class _CouponCardState extends State<CouponCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final dynamicIconSize = (screenWidth(context) * 0.08).clamp(32.0, 40.0);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          CouponCard(
            title: "Get 20% OFF",
            subtitle: "Valid on all products above ₹500. Limited time offer for new customers only.",
            promoCode: "SAVE20",
          ),
          CouponCard(
            title: "Free Delivery",
            subtitle: "No delivery charges on orders above ₹299. This is a longer subtitle to test the dynamic height adjustment of the ticket widget.",
            promoCode: "FREEDEL",
          ),
          CouponCard(
            title: "Buy 2 Get 1 Free",
            subtitle: "Applicable on selected items in electronics category. This offer is valid for a limited time and cannot be combined with other offers. Terms and conditions apply for all purchases.",
            promoCode: "B2G1FREE",
          ),
        ],
      ),
